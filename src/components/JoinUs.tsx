        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <GlassCard className="lg:col-span-2 p-10 rounded-3xl border-l-4 border-celestial-saturn relative overflow-hidden">
            ...
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <p className="text-[10px] uppercase tracking-widest text-white/40 font-bold">Reward Protocol</p>
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-2">
                    <div className="flex items-center gap-2 text-celestial-saturn font-bold text-2xl">
                      <Sparkles size={24} />
                      {t.civilizationCredits}
                    </div>
                    <p className="text-xs text-white/40">Soul Credits (SC) are minted based on uptime and compute quality.</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <p className="text-[10px] uppercase tracking-widest text-white/40 font-bold">Global Mesh Status</p>
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-2">
                    <div className="text-white font-bold text-2xl flex items-center gap-2">
                      <Globe size={24} className="text-celestial-glow" />
                      14,204 Nodes
                    </div>
                    <p className="text-xs text-white/40">Distributed across 82 countries. Total mesh power: 4.2 PFLOPS.</p>
                  </div>
                </div>
              </div>
          ...
          <GlassCard className="p-8 rounded-3xl flex flex-col justify-between space-y-8 relative overflow-hidden group">
            ...
            <div className="space-y-6 relative z-10">
              <h3 className="text-xl font-bold tracking-tight">Node Simulator</h3>
              <div className="space-y-4">
              ...
              <p className="text-xs text-white/40 leading-relaxed">
                Estimate your contribution value based on your hardware profile and network latency.
              </p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {isGenesisMode ? (
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-white/40 uppercase tracking-widest">Quick Action</label>
                  <Button 
                    type="button"
        ...
        {isOpen && (
          <>
            ...
            >
              <div className="space-y-4">
                <div className="space-y-2">
                  <p className="text-[10px] uppercase tracking-widest text-white/40 font-bold">Direct Contact</p>
                ...
                {userRole === 'admin' && (
                  <div className="pt-4 border-t border-white/10 space-y-3">
                    <div className="flex items-center justify-between">
                      <p className="text-[10px] uppercase tracking-widest text-celestial-saturn font-bold">Admin Config</p>
                      {!isEditing && (
                        <button onClick={() => setIsEditing(true)} className="text-[10px] text-white/40 hover:text-white underline">Edit</button>
                      )}
                    </div>
