  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <span className={`text-[10px] font-bold px-3 py-1 rounded-full ${configured ? 'bg-green-500/10 text-green-400' : 'bg-white/5 text-white/30'}`}>
      ...
      <div className="space-y-3">
        <div>
          <label className="text-[10px] font-bold text-white/40 uppercase block mb-1">Corp ID (企业ID)</label>
        ...
        <div>
          <label className="text-[10px] font-bold text-white/40 uppercase block mb-1">Agent ID (应用ID)</label>
        ...
        <div>
          <label className="text-[10px] font-bold text-white/40 uppercase block mb-1">App Secret (应用Secret)</label>
        ...
        <div>
          <label className="text-[10px] font-bold text-white/40 uppercase block mb-1">Token (回调Token)</label>
        ...
        <div>
          <label className="text-[10px] font-bold text-white/40 uppercase block mb-1">Encoding AES Key</label>
      ...
      <div className="p-3 rounded-xl bg-white/5 border border-white/5 text-[10px] text-white/30 space-y-1">
