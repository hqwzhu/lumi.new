...
[English README](README.md) | [Windows 下载](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.1)
...
[https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.1](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.1)

普通用户只需要下载这个文件：

[`LumiOS-Windows-3.0.1-x64-setup.exe`](https://github.com/hqwzhu/lumi.new/releases/download/windows-v3.0.1/LumiOS-Windows-3.0.1-x64-setup.exe)

发布页里还包含：

| 文件 | 用途 |
| --- | --- |
| `LumiOS-Windows-3.0.1-x64-setup.exe` | Windows 安装器，普通用户下载这个 |
| `LumiOS-Windows-3.0.1.zip` | 完整发布包，适合备份或内部交付 |
...
```text
dbf998ad7cacc3fae98a7b371b54dade429ae4fcc4c1ba464ae1190c09cedf97
```
