...
[English README](README.md) | [Windows 下载](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.3)
...
[https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.3](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.3)

普通用户只需要下载这个文件：

[`LumiOS-Windows-3.0.3-x64-setup.exe`](https://github.com/hqwzhu/lumi.new/releases/download/windows-v3.0.3/LumiOS-Windows-3.0.3-x64-setup.exe)

发布页里还包含：

| 文件 | 用途 |
| --- | --- |
| `LumiOS-Windows-3.0.3-x64-setup.exe` | Windows 安装器，普通用户下载这个 |
| `LumiOS-Windows-3.0.3.zip` | 完整发布包，适合备份或内部交付 |
...
```text
d8f576fd66ac695b8a5d2608eacc8c8bcd581c9989549f973041b8ff9d62b064
```
