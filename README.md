...
[中文说明](README.zh-CN.md) | [Windows 下载 / Windows Download](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.3)
...
- Release 页面：[Lumi OS 3.0.3 Windows](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.3)
- 普通用户下载：[`LumiOS-Windows-3.0.3-x64-setup.exe`](https://github.com/hqwzhu/lumi.new/releases/download/windows-v3.0.3/LumiOS-Windows-3.0.3-x64-setup.exe)
- 完整发布包：[`LumiOS-Windows-3.0.3.zip`](https://github.com/hqwzhu/lumi.new/releases/download/windows-v3.0.3/LumiOS-Windows-3.0.3.zip)
- 校验文件：[`SHA256SUMS.txt`](https://github.com/hqwzhu/lumi.new/releases/download/windows-v3.0.3/SHA256SUMS.txt)
...
1. 下载 `LumiOS-Windows-3.0.3-x64-setup.exe`。
