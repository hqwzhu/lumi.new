...
[`LumiOS-Windows-3.0.5-x64-setup.exe`](https://github.com/hqwzhu/lumi.new/releases/download/windows-v3.0.5/LumiOS-Windows-3.0.5-x64-setup.exe)
...
| 文件 | 用途 |
| --- | --- |
| `LumiOS-Windows-3.0.5-x64-setup.exe` | Windows 安装器，普通用户下载这个 |
