...
[English README](README.md) | [Windows 下载](https://github.com/hqwzhu/lumi.new/releases/tag/windows-v3.0.0)
...
| 文件 | 用途 |
| --- | --- |
| `LumiOS-Windows-3.0.0-x64-setup.exe` | Windows 安装器，普通用户下载这个 |
| `LumiOS-Windows-3.0.0.zip` | 完整发布包，适合备份或内部交付 |
...
```text
89b10e4b127105ad2026f4f3e1664aadeab0bd23a25062a2055a15c6950485db
```
